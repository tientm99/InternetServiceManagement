		...
		<div class="row border-bottom">
			...
			<div class="col-10 d-flex justify-content-center p-4">
				<div class="card shadow-lg" style="width: 600px;">
					...
					<div class="card-body">
						<form:form action="${pageContext.request.contextPath}/dangkysdmay"
							method="post" modelAttribute="sudungmay">
							<div class="form-group">
								<label for="exampleInputEmail1">Mã khách hàng</label>
								<form:input path="id.maKH" name="maKH" type="text"
