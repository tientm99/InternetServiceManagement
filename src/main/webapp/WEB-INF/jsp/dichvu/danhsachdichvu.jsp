...
<body>
	...
	<div class="container-fluid">
		...
		<script>
		    function setDeleteId(maDV) {
		        document.getElementById('deleteLink').href = 'deletedichvu?id=' + maDV;
		    }
		</script>
</body>
</html>