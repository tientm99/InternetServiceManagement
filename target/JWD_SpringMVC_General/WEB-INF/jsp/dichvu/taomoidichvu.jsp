...
<body>
	<c:if test="${not empty taomoiDV}">
		<jsp:include page="${taomoiDV}.jsp" />
	</c:if>
	<div class="container mt-5" style="width: 600px;">
		<div class="card shadow-lg">
			<h5 class="card-header text-center">Tạo Mới Dịch Vụ</h5>
			<div class="card-body">
				<form:form action="${pageContext.request.contextPath}/taomoidichvu" method="post" modelAttribute="dichvu">
