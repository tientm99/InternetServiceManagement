...
<body>
	...
	<div class="container mt-5" style="width: 600px;">
		<div class="card shadow-lg">
			...
			<div class="card-body">
				<form:form action="${pageContext.request.contextPath}/capnhatkhachhang" method="post" modelAttribute="updateKH">
					<div class="form-group">
						<label for="exampleInputEmail1">Mã khách hàng</label>
						 <form:input path="maKH"
							type="text" class="form-control" placeholder="Mã khách hàng" readonly="true"/>
