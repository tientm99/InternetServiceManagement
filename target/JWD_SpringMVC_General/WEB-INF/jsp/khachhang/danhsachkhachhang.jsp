...
<body>
	<c:if test="${not empty danhsachKH}">
		<jsp:include page="${danhsachKH}.jsp" />
	</c:if>
				...
				<div class="row">
					...
					<div class="col-4">
						<form class="form-inline mt-3 mb-3"
							...
							method="get">
							<input class="form-control mr-sm-2" name="tenkhachhang" type="text"
								placeholder="Search">
					...
					<tbody class="bg-light">
						<c:forEach var="khachhang" items="${listKH}" varStatus="count">
							<tr>
								...
								<td>
								<a href="updatekhachhang/${khachhang.maKH}">
			                      ...
			                      <div class="modal-dialog">
			                        <div class="modal-content">
			                          ...
			                          <div class="modal-footer">
			                            ...
			                            <a href="deletekhachhang?id=${khachhang.maKH}">
